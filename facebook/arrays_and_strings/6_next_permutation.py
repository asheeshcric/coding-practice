class Solution:
    def nextPermutation(self, nums: List[int]) -> None:
        ...
        decreasing sequence
        2. Record the index from where the decreasing sequence starts. Also, keep track of the smallest number
        in the decreasing sequence
        3. Swap the current number with the smallest one and then reverse the part of the list starting from that index.
